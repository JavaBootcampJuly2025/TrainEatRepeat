INSERT INTO USERS (uuid, username, email, password, age, gender, weight, height, BMI, BMR, role, verification_code, verification_expires_at, is_email_verified, reset_token, reset_token_expires_at)
VALUES
    ...
    ('123e4567-e89b-12d3-a456-426614174000', 'alex_fitness', 'alex@example.com', '$2a$12$FDmRf4QVE0zXwaJKtcTE8O3zyYo2qlKlscuTfNbOus2B0KiSMyzO6', 32, 'Male', 82.0, 178.0, 25.88, 1850.0, 'user', NULL, NULL, TRUE, NULL, NULL),
